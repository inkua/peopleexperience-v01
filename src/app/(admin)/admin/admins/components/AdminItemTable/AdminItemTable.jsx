            ...
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div className="inline-flex items-center gap-x-3">
                    <div className="flex items-center gap-x-2">
                        ...
                        <div>
                            <h2 className="font-normal text-gray-800 dark:text-white ">{admin.name}</h2>
                            <p className="text-xs font-normal text-gray-500 dark:text-gray-400">{admin.id}</p>
                        </div>
                    </div>
                </div>
            </td>
            <td className="px-12 py-4 text-sm font-normal text-gray-700 whitespace-nowrap">{admin.id}</td>
